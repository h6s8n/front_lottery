  ...
  <div class="min-h-screen bg-gradient-to-br from-[#FF6B6B] via-[#FF8E8E] to-[#FFB6B6] text-white font-vazir overflow-hidden">
    ...
    <div class="relative z-10 container mx-auto p-4 pb-24">
      ...
      <div class="text-center my-8">
        <a href="https://t.me/LotteryAbolBot?start=ref" target="_blank" class="inline-block px-10 py-4 text-xl font-bold bg-yellow-400 text-gray-900 rounded-full shadow-lg hover:bg-yellow-300 transition-all transform hover:scale-105">
          دعوت از دوستان 🚀
        </a>
      </div>
